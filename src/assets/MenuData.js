export const data = [
    {
        ...
        <path d="M16.2799 13.61C15.1499 14.74 13.5299 15.09 12.0999 14.64L9.50995 17.22C9.32995 17.41 8.95995 17.53 8.68995 17.49L7.48995 17.33C7.08995 17.28 6.72995 16.9 6.66995 16.51L6.50995 15.31C6.46995 15.05 6.59995 14.68 6.77995 14.49L9.35995 11.91C8.91995 10.48 9.25995 8.86001 10.3899 7.73001C12.0099 6.11001 14.6499 6.11001 16.2799 7.73001C17.8999 9.34001 17.8999 11.98 16.2799 13.61Z" stroke="#9197B3" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M10.4501 16.28L9.6001 15.42" stroke="#9197B3" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
...
export const studentsTopInfos = [
    {
        image: <svg width="90" height="85" viewBox="0 0 90 85" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="44.6776" cy="42.442" rx="44.6781" ry="42.442" fill="url(#paint0_linear_323_143)"/>
                <path d="M40.4539 41.4546C40.2677 41.4369 40.0443 41.4369 39.8395 41.4546C35.409 41.3131 31.8906 37.8647 31.8906 33.6205C31.8906 29.2879 35.5765 25.7687 40.156 25.7687C44.7169 25.7687 48.4215 29.2879 48.4215 33.6205C48.4028 37.8647 44.8844 41.3131 40.4539 41.4546Z" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M53.9497 29.3048C57.5612 29.3048 60.4653 32.0812 60.4653 35.4943C60.4653 38.8366 57.6729 41.56 54.1917 41.6837C54.0428 41.6661 53.8753 41.6661 53.7077 41.6837" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M31.1462 47.9793C26.6412 50.8441 26.6412 55.5128 31.1462 58.3599C36.2656 61.6138 44.6613 61.6138 49.7807 58.3599C54.2857 55.4951 54.2857 50.8265 49.7807 47.9793C44.6799 44.7431 36.2842 44.7431 31.1462 47.9793Z" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M57.5427 57.6002C58.883 57.3349 60.1489 56.8221 61.1914 56.0617C64.0954 53.9926 64.0954 50.5796 61.1914 48.5106C60.1675 47.7678 58.9202 47.2727 57.5985 46.9897" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                <defs>
                <linearGradient id="paint0_linear_323_143" x1="79.3032" y1="2.16451e-06" x2="47.6536" y2="85.9795" gradientUnits="userSpaceOnUse">
                <stop stop-color="#D3FFE7"/>
                <stop offset="1" stop-color="#EFFFF6"/>
                </linearGradient>
                </defs>
                </svg>,
        text: 'Hamma o`quvchilar',
        soni: '125 ta',
        image2: <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.2676 17.8428L11.2676 5.71649" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M5.06229 10.7691L11.2676 4.87439L17.4729 10.7691" stroke="#00AC4F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>,
        change: '18%',
        type: 'green'
    },
    {
        image: <svg width="89" height="84" viewBox="0 0 89 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="44.2124" cy="42" rx="44.2128" ry="42" fill="url(#paint0_linear_323_156)"/>
                <path d="M48.4932 53.75L51.16 56.2834L56.4937 51.2167" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M44.4934 40.117C44.3179 40.1003 44.1074 40.1003 43.9144 40.117C39.7388 39.9837 36.4228 36.7337 36.4228 32.7337C36.4053 28.6503 39.8967 25.3337 44.1951 25.3337C48.4936 25.3337 51.985 28.6503 51.985 32.7337C51.985 36.7337 48.6515 39.9837 44.4934 40.117Z" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M44.1946 58.3498C41.0015 58.3498 37.8259 57.5832 35.4047 56.0498C31.1589 53.3498 31.1589 48.9498 35.4047 46.2665C40.2295 43.1998 48.1422 43.1998 52.967 46.2665" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <defs>
                <linearGradient id="paint0_linear_323_156" x1="78.4773" y1="2.14197e-06" x2="47.1573" y2="85.0841" gradientUnits="userSpaceOnUse">
                <stop stop-color="#D3FFE7"/>
                <stop offset="1" stop-color="#EFFFF6"/>
                </linearGradient>
                </defs>
                </svg>,
        text: 'Bitirgan o`quvchilar',
        soni: '61 ta',
        type: 'green'
    },
    {
        image: <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="42" cy="42" r="42" fill="url(#paint0_linear_1_619)"/>
                <path d="M42.3347 45.117C42.1593 45.1003 41.9488 45.1003 41.7558 45.117C37.5801 44.9837 34.2641 41.7337 34.2641 37.7337C34.2466 33.6503 37.738 30.3337 42.0365 30.3337C46.3349 30.3337 49.8264 33.6503 49.8264 37.7337C49.8264 41.7337 46.4929 44.9837 42.3347 45.117Z" stroke="#DF0404" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M42.036 63.3498C38.8428 63.3498 35.6672 62.5832 33.2461 61.0498C29.0002 58.3498 29.0002 53.9498 33.2461 51.2665C38.0709 48.1998 45.9836 48.1998 50.8084 51.2665" stroke="#DF0404" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                <defs>
                <linearGradient id="paint0_linear_1_619" x1="74.55" y1="2.14197e-06" x2="42" y2="84" gradientUnits="userSpaceOnUse">
                <stop stop-color="#FFA3CF"/>
                <stop offset="1" stop-color="#FFD5F3"/>
                </linearGradient>
                </defs>
                </svg>,
        text: 'Ketgan o`quvchilar',
        soni: '10 ta',
        image2: <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10.5264 3L10.5264 15" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M16.6671 9.99999L10.5264 15.8333L4.38575 9.99999" stroke="#D0004B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>,
        change: '1%',
        type: 'red'
    },
    {
        image: <svg width="89" height="84" viewBox="0 0 89 84" fill="none" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="44.2128" cy="42" rx="44.2128" ry="42" fill="url(#paint0_linear_323_168)"/>
        <path d="M33.9701 24.5H54.437C60.9952 24.5 62.6348 26.0575 62.6348 32.27V43.3475C62.6348 49.5775 60.9952 51.1175 54.4554 51.1175H33.9701C27.4303 51.135 25.7908 49.5775 25.7908 43.365V32.27C25.7908 26.0575 27.4303 24.5 33.9701 24.5Z" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M44.2128 51.1345V59.4995" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M25.7908 43.75H62.6348" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M35.9229 59.5H52.5027" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
        <defs>
        <linearGradient id="paint0_linear_323_168" x1="78.4777" y1="2.14197e-06" x2="47.1578" y2="85.0841" gradientUnits="userSpaceOnUse">
        <stop stop-color="#D3FFE7"/>
        <stop offset="1" stop-color="#EFFFF6"/>
        </linearGradient>
        </defs>
